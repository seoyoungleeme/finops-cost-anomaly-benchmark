...
```text
outputs/results/focus_calibration_stats.csv          calibration parameters per service
outputs/results/focus_calibration_summary.csv        cross-service summary stats of calibration parameters
outputs/results/focus_metrics_<service>.csv          raw metrics per service (all seeds/budgets)
outputs/results/focus_events_<service>.csv           event-level results per service
outputs/results/focus_service_summary.csv            one-row-per-service averaged across models & seeds
outputs/results/focus_core_metrics_by_service.csv    mean +/- std of key metrics per service x model
outputs/results/focus_rank_reversal_by_service.csv   model rank per service for 4 metrics
outputs/results/focus_rank_reversal_summary.csv      model-pair rank reversal rates across metrics & services
outputs/results/focus_overall_model_ranking.csv      aggregated model ranking across all services
outputs/results/focus_anomaly_type_results.csv       detection metrics by model x anomaly type
outputs/results/focus_anomaly_intensity_results.csv  detection metrics by model x type x intensity
outputs/results/focus_top_model_disagreement_summary.csv  per-service F1-vs-other-metric top-model disagreement
outputs/results/focus_run_metadata.json              run metadata for research reproducibility

outputs/figures/focus_f1_bar.png
outputs/figures/focus_dollar_recall_bar.png
outputs/figures/focus_ace_bar.png
outputs/figures/focus_mctd_bar.png
outputs/figures/focus_f1_by_budget.png
outputs/figures/focus_mctd_by_budget.png
outputs/figures/focus_far_by_budget.png
outputs/figures/focus_metric_overview.png
outputs/figures/focus_detection_by_type.png
outputs/figures/focus_detection_heatmap.png
outputs/figures/focus_mctd_by_type.png
outputs/figures/focus_radar.png
outputs/figures/focus_rank_slope.png
```
